...
let foodArray=['pasta', 'sushi', 'steak', 'potatoes', 'curry'];
...
console.log('I have', foodArray.length, 'favorite foods');
...
foodArray.push('ice cream');
console.log('Added a new food to the end,', foodArray);
...
foodArray.unshift('frozen yogurt')
console.log('Added', foodArray[0], 'to the beggining on the list')
console.log('My favorite foods are now:', foodArray);
...
console.log('Decided that', removedFood, 'did not belong on the list');
